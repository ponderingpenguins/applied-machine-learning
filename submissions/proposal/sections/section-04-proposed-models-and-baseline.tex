...
For the main model, we plan to use a transformer because it can learn relationships across the time dimension of the gait windows instead of relying only on hand-crafted summary features. The transformer will be trained with triplet loss so that windows from the same person move closer together in embedding space and windows from different people move farther apart.
